...
#define GIMBAL_PITCH_BIAS (9.37f - 12.07f) // pitch最低角度(imu测得) - 实际最低角度(机械处测得)

#define GIMBAL_PITCH_MOTOR_SIGN -1.0f //云台PITCH电机方向，向上为正

#define GIMBAL_ANGLE_MIN -12.00f //软限位
#define GIMBAL_ANGLE_MAX 30.00f

#define GIMBAL_PITCH_COMP_COEF 0.8f
...
//摩擦力模型调参
#define BORDER_FRICTION_SPEED 2.0f    //临界计算摩擦力速度，大于此速度将是全摩擦力补偿
#define FRICTION_CURRENT_COMP 2000.0f //辨识所得到的摩擦力电流发送值
