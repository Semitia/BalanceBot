...
#define BLUE_TOOTH_SEND_DMAx_Streamx_IRQn DMA1_Stream1_IRQn
#define BLUE_TOOTH_SEND_DMAx_Streamx DMA1_Stream1
...
#define BLUE_TOOTH_SEND_DMAx_Streamx_IRQHandler DMA1_Stream1_IRQHandler
