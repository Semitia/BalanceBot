...
void Can2_FIFO0_Receive0(CanRxMsg *rx_message0)
{
    ...
    // debug
    global_debugger.imu_debugger[0].can_dt = GetDeltaT(&global_debugger.imu_debugger[0].last_can_cnt);
    global_debugger.imu_debugger[0].recv_msgs_num++;
    if (global_debugger.imu_debugger[0].can_dt > 0.0015f)
    {
        global_debugger.imu_debugger[0].loss_num++;
    }
}
...
void Can2_FIFO0_Receive1(CanRxMsg *rx_message0)
{
    ...
    global_debugger.imu_debugger[1].can_dt = GetDeltaT(&global_debugger.imu_debugger[1].last_can_cnt);
    global_debugger.imu_debugger[1].recv_msgs_num++;
    if (global_debugger.imu_debugger[1].can_dt > 0.0015f)
    {
        global_debugger.imu_debugger[1].loss_num++;
    }
}
...
void Can2_FIFO0_Receive2(CanRxMsg *rx_message0)
{
    ...
    global_debugger.gimbal_debugger[1].can_dt = GetDeltaT(&global_debugger.gimbal_debugger[1].last_can_cnt);
    global_debugger.gimbal_debugger[1].recv_msgs_num++;
    if (global_debugger.gimbal_debugger[1].can_dt > 0.0015f)
    {
        global_debugger.gimbal_debugger[1].loss_num++;
    }
}
...
void Can2_FIFO1_Receive0(CanRxMsg *rx_message1)
{
    ...
    global_debugger.gimbal_debugger[0].can_dt = GetDeltaT(&global_debugger.gimbal_debugger[0].last_can_cnt);
    global_debugger.gimbal_debugger[0].recv_msgs_num++;
    if (global_debugger.gimbal_debugger[0].can_dt > 0.0015f)
    {
        global_debugger.gimbal_debugger[0].loss_num++;
    }
}
...
void Can2_FIFO1_Receive1(CanRxMsg *rx_message1)
{
    ...
    global_debugger.friction_debugger[LEFT_FRICTION_WHEEL].can_dt = GetDeltaT(&global_debugger.friction_debugger[LEFT_FRICTION_WHEEL].last_can_cnt);
    global_debugger.friction_debugger[LEFT_FRICTION_WHEEL].recv_msgs_num++;
    if (global_debugger.friction_debugger[LEFT_FRICTION_WHEEL].can_dt > 0.0015f)
    {
        global_debugger.friction_debugger[LEFT_FRICTION_WHEEL].loss_num++;
    }
}
...
void Can2_FIFO1_Receive2(CanRxMsg *rx_message1)
{
    ...
    global_debugger.friction_debugger[RIGHT_FRICTION_WHEEL].can_dt = GetDeltaT(&global_debugger.friction_debugger[RIGHT_FRICTION_WHEEL].last_can_cnt);
    global_debugger.friction_debugger[RIGHT_FRICTION_WHEEL].recv_msgs_num++;
    if (global_debugger.friction_debugger[RIGHT_FRICTION_WHEEL].can_dt > 0.0015f)
    {
        global_debugger.friction_debugger[RIGHT_FRICTION_WHEEL].loss_num++;
    }
}
